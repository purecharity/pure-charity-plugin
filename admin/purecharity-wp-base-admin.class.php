...
class Purecharity_Wp_Base_Admin {
	...
	public static function one_time_render(  ) { 
		...
		$options = get_option( 'pure_base_settings' );
		?>
		<input type="text" name="pure_base_settings[one_time]" id="one_time" value="<?php echo @$options['one_time']; ?>">
	...
	public static function recurring_render(  ) { 
		...
		$options = get_option( 'pure_base_settings' );
		?>
		<input type="text" name="pure_base_settings[recurring]" id="recurring" value="<?php echo @$options['recurring']; ?>">
	...
	public static function allowed_custom_fields_render(  ) {
		$options = get_option( 'pure_base_settings' );
		?>
		<input type="hidden" name="pure_base_settings[allowed_custom_fields]" id="custom_fields_value" value="<?php echo @$options['allowed_custom_fields']; ?>">
